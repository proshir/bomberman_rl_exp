...
| Pre-combat evaluation suite | Standardized gate before `classic` opponents | Manifest and runner created; evaluates three checkpoints per candidate on 96 held-out games per scenario, for both Coin Heaven and Loot Crate | [`../eval_suite/README.md`](../eval_suite/README.md) |
